...
def expConstr1(Input):#You are free to pick this name but it has to be similar to the one in the xml#
  ...
  """
  # add the first explicit constraint here in case you have any
  pass
...
def expConstr2(Input):
  ...
  """
  # add the second explicit constraint here in case you have any
  pass
...
def impConstr2(Input):
  ...
  """
  g = (2.1 - Input.pin_peaking) * 400 # I'd remove the 400 but this is to match your fitness. Change this to the name of Fq in PARCS
  return g
...
def impConstr3(Input):
  """
    ...
    @ out, g, float, implicit constraint 2 evaluation function
  """
  g = (Input.MaxFDH - 1.48) * 400 # I'd remove the 400 but this is to match your fitness. Change this to the name of Fh in PARCS
  return g