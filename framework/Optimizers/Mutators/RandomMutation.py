...
"""
  Implementation of Random Mutation for Mutation process of Genetic Algorithm
"""
import numpy as np
from utils import InputData, InputTypes, randomUtils, mathUtils
from . import Mutators

class RandomMutation(Mutators):
  """
    Uses Random Mutation approach to Mutate children
  """
  ##########################
  ...
  def getInputSpecification(cls):
    ...
    """
    specs = super(RandomMutation, cls).getInputSpecification()
